...
(function() {
  var Tuner, frequencies, looped_frequencies, root,
  ...
  Tuner = function(onUpdate, noiseThresholdMultiplier) {
    var audioContext, buffer, bufferFillSize, bufferFiller, canvas, context, currentDiff, currentFrequency, currentLogFrequency, currentLoopedNote, currentNum, error, fft, fftSize, gauss, hp, i, lp, sampleRate, success;
    ...
    success = function(stream) {
        ...
        process = function() {
          ...
          if (peaks.length > 0) {
            ...
            if (peaks.length > 1 || maxPeaks === 1) {
              ...
              _ref5 = getPitch(freq), currentNote = _ref5[0], currentDiff = _ref5[1], currentLoopedNote = _ref5[2], currentNum = _ref5[3];
      ...
      getPitch = function(freq) {
        var diff, key, loopedNote, minDiff, note, num, val;
        minDiff = Infinity;
        diff = Infinity;
        loopedNote = null;
        num = null;
        ...
        return [note, diff, loopedNote, num];
      };
      display = {
